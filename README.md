...
The third and final lambda function serves as a decision maker, sending of emails and storing of data into a database. This function will check the CSV file to classify if the form is void or non void. If the form void, an email will be automatically sent to the customer in regards to a _void form_ via **SES**. Else if the form is _non void_, it will begin processing of the reasoning via **Amazon Comprehend**.
...
> Gaanesh: Gaaneshtheivasigamani@gmail.com
